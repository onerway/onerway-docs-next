...
Every payment order you create generates a complete transaction record. View and manage your transactions in the :docs-dropdown-menu{preset="merchant-dashboard" path="/transaction/query" label="Onerway Dashboard"}.

### Transaction list

1. Access your :docs-dropdown-menu{preset="merchant-dashboard" path="/transaction/query" label="Onerway Dashboard"}
...
::tabs
  ...
  :::tabs-item{label="Transaction Info"}
  ...
  :::tabs-item{label="3D Authentication"}
  - **3D Secure**: Whether additional authentication was required
  - **ECI**: Electronic Commerce Indicator
  :::

  :::tabs-item{label="Risk Control Info"}
  ...
  :::tabs-item{label="Customer Address"}
