  ...
  :::tabs-item{label="Web" icon="i-lucide-globe"}
    ...
    ::tabs{variant="link" sync="integration-method"}
      ...
      Redirect to a Onerway-hosted payment page using [Onerway Checkout](https://demo.onerway.com/standard-checkout). See how this integration compares to Onerway's [other integration types](/mock/integration-types).
        ...
        :::u-page-section{:ui='{"body": "mt-0", "container": "py-8 sm:py-12 lg:py-16 gap-12 sm:gap-16 flex-col-reverse border border-default rounded-lg", "features": "text-default", "footer": "mt-4"}'}
        ---
        ...
        #features
          ...
          #description
            ...
            ---
              :::u-button{variant="link" color="neutral" label="Limited customization" class="px-0"}
              :::
        ...
        #links
          ...
          :::u-button{variant="solid" color="neutral" label="Try it out" trailingIcon="i-lucide-external-link" to="https://demo.onerway.com/standard-checkout"}
          :::
      ...
      [Get your API credentials](/get-started/start-building/start-developing#get-your-api-credentials) and access the Onerway API from your application:
        ...
        ---
          ...
          :::accordion-item{icon="healthicons:1"}
          ...
          :::accordion-item{icon="healthicons:2"}
          ...
          :::accordion-item{icon="healthicons:3"}
          ...
          :::accordion-item{icon="healthicons:4"}
