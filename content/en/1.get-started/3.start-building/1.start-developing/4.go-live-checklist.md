...
- [ ] Register your [production webhooks](#){badge="TODO"}
- [ ] Subscribe to the [API announcements](#){badge="TODO"} mailing list
...
Onerway logs every request made with your API keys, with these records being viewable in the [Dashboard](#){badge="TODO"}. We recommend maintaining your own logs in addition to Onerway's logs, despite the apparent redundancy. Your own logs serve as a backup if your server has a problem contacting Onerway or you have an issue with your API keys—both cases would prevent us from logging your request.
...
Your Onerway account can have both test and live [webhook endpoints](#){badge="TODO"}. If you're using webhooks, make sure you've defined live endpoints in your Onerway account. Then confirm the live endpoint functions exactly the same as your test endpoint.
...
2. **Subscribe to API updates** - Join our [API announcements mailing list](#){badge="TODO"} to keep up with new features and changes
3. **Monitor your first transactions** - Check the [Dashboard](#){badge="TODO"} regularly during your first few days to catch any issues early
