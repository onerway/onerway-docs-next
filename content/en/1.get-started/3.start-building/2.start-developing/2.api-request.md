...
Every account comes with complete [API credential sets](./set-up-your-development-environment#get-your-api-credentials) for both sandbox and production environments.
