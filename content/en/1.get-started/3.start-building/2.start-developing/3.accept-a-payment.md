...
::prose-tabs{variant="segment" sync="platform-tabs"}
    ...
    ::prose-tabs{variant="link" sync="integration-method"}
      ...
      [Get your API credentials](/get-started/start-building/start-developing#get-your-api-credentials) and access the Onerway API from your application:
        ...
        ---
          ...
          3. Click your pay button
          4. Fill out the payment form with the test card information:
          ...
          6. You're redirected to the success page
