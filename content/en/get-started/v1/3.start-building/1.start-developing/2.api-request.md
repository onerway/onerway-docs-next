...
Every account comes with complete [API credential sets](development-environment#get-your-api-credentials) for both sandbox and production environments.
...
|-------------|-------|--------|
| `4761344136141390` | Visa | Payment successful |
| `4000020951595032` | Visa | Requires 3DS verification |
| `4000128449498204` | Visa | Card declined |
...
Every payment order you create generates a complete transaction record. View and manage your transactions in the merchant dashboard ([Sandbox](https://sandbox-portal.onerway.com/transaction/query) | [Production](https://portal.onerway.com/transaction/query)).
...
1. Access your **merchant dashboard ([Sandbox](https://sandbox-portal.onerway.com/transaction/query) | [Production](https://portal.onerway.com/transaction/query))**
