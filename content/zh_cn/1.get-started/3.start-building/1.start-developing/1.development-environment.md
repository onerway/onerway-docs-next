...
- 配置 :prose-annotation{annotation="用于请求 Onerway API" text="请求域名"}
...
---
  ...
  :::prose-accordion-item{label="创建沙盒账户" icon="i-lucide-circle-help"}

    ::::h4{class="sr-only"}
    创建沙盒账户
    ::::

  要创建沙盒账户，请提供您的 :prose-annotation{annotation="用于接收登录信息" text="邮箱"} 和将要集成支付的 :prose-annotation{annotation="用于校验支付请求发起方" text="域名"}。Onerway 通常会在 1-2 个工作日内为您设置好测试环境。
  :::

  :::prose-accordion-item{label="获取您的 API 凭证" icon="i-lucide-circle-help"}
  ...
  :::prose-accordion-item{label="设置请求域名" icon="i-lucide-circle-help"}
